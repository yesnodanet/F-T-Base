...
if CLIENT then
	...
	local band = bit.band
	function TFA.ShouldSkipVMDraw(ent, wep, flags)
		if not flags then return false end

		if band(flags, STUDIO_SSAODEPTHTEXTURE) == STUDIO_SSAODEPTHTEXTURE or band(flags, STUDIO_SHADOWDEPTHTEXTURE) == STUDIO_SHADOWDEPTHTEXTURE then
			return true
		end
