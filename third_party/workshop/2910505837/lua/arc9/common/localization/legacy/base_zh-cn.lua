...
/////////////////////////////////////// General
--[[
For preservation purposes, this file includes all the old strings used in the Settings Menu.
They were originally translated by TheOnly8Z.
--]]
...
////////////////////// General
L["settings.quick.lang.title"] = "语言"
...
L["settings.gameplay.cheapscopes.desc"] = "通过放大玩家视角来进行瞄具渲染，而不是渲染两次。在较大的地图上会显著提升性能。"
L["settings.tpik.title"] = "TPIK"
L["settings.tpik.desc"] = "TPIK (第三人称逆运动动画) 可将第一人称的手部动作表现在你的第三人称角色上。\n\n在 “视觉” 设置里可调整详细信息。"
L["settings.effects.allflash.title"] = "第三人称手电筒"
L["settings.effects.allflash.desc"] = "将其他玩家的手电以完整光源表现。\n\n对服务器压力很大。"

L["settings.tabname.blur"] = "模糊化"
L["settings.blur.cust_blur.title"] = "自定义菜单背景"
L["settings.blur.cust_blur.desc"] = "自定义菜单背景进行模糊处理。"
L["settings.blur.fx_reloadblur.title"] = "装填时"
L["settings.blur.fx_reloadblur.desc"] = "装填时模糊屏幕。"
L["settings.blur.fx_animblur.title"] = "准备武器时"
L["settings.blur.fx_animblur.desc"] = "第一次掏出武器时模糊屏幕。"
L["settings.blur.fx_rtblur.title"] = "使用准镜时"
L["settings.blur.fx_rtblur.desc"] = "有倍率的准镜会模糊准镜外的视野。"
L["settings.blur.fx_adsblur.title"] = "瞄准时"
L["settings.blur.fx_adsblur.desc"] = "武器会在瞄准时模糊。"

L["settings.performance.shelleject.title"] = "弹壳"
L["settings.effects.eject_fx.title"] = "烟雾效果"
L["settings.effects.eject_fx.desc"] = "启用时弹壳会冒烟。只有特定武器支持此功能。"
L["settings.effects.eject_time.title"] = "额外时间"
L["settings.effects.eject_time.desc"] = "让弹壳再飞一会。弹壳太多会影响性能。"

L["settings.tabname.effects"] = "特效"
L["settings.effects.muzzle_light.title"] = "枪火光效"
L["settings.effects.muzzle_light.desc"] = "开火时会短暂显示光源。"
L["settings.effects.muzzle_others.title"] = "他人枪口特效"
L["settings.effects.muzzle_others.desc"] = "显示其他玩家的枪口特效。"

////////////////////// Optics
L["settings.tabname.optics"] = "瞄具"

L["settings.optics.control"] = "操作"
L["settings.gameplay.compensate_sens.title"] = "鼠标灵敏度自动调整"
L["settings.gameplay.compensate_sens.desc"] = "根据准镜放大倍率调整灵敏度。"
L["settings.gameplay.toggleads.title"] = "切换瞄准"
L["settings.gameplay.toggleads.desc"] = "按一次瞄准键进入或退出瞄准，而不是按住。"

L["settings.optics.color"] = "颜色"
L["settings.gameplay.color.reflex.title"] = "全息"
L["settings.gameplay.color.reflex.desc"] = "全息/反射瞄具的准心颜色。\n\n只有部分瞄具支持这个功能。"
L["settings.gameplay.color.scope.title"] = "准镜"
L["settings.gameplay.color.scope.desc"] = "放大瞄具的准心颜色。\n\n只有部分瞄具支持这个功能。"
...
L["settings.hud_game.hud_scale.desc"] = "全局界面大小倍率。"
L["settings.custmenu.hud_color.title"] = "HUD 颜色"
L["settings.custmenu.hud_color.desc"] = "主题高亮颜色。"
L["settings.custmenu.cust_light.title"] = "自定义界面灯光"
L["settings.custmenu.cust_light.desc"] = "切换灯光效果。"
L["settings.custmenu.cust_light_brightness.title"] = "自定义灯光强度"
L["settings.custmenu.cust_light_brightness.desc"] = "调整自定义界面的照明。\n\n不要忘记先打开灯光再看效果。"

L["settings.custmenu.customization"] = "自定义"
L["settings.custmenu.cust_hints.title"] = "提示"
L["settings.custmenu.cust_hints.desc"] = "自定义菜单的键位提示。"
L["settings.custmenu.cust_exit_reset_sel.title"] = "退出时重置选择"
...
L["settings.centerhint.breath_hud.desc"] = "瞄准屏气时显示剩余时间。"
L["settings.centerhint.breath_pp.title"] = "屏气后处理效果"
L["settings.centerhint.breath_pp.desc"] = "启用屏气时的特殊视觉效果。"
...
L["settings.vm.vm_addy.title"] = "Y 轴偏移"
L["settings.vm.vm_addy.desc"] = "调整第一人称模型的前后位置。"
...
L["settings.tabname.quickstat"] = "快捷属性修改"
