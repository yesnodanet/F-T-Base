...
L["ammo.slam"] = "SLAM"
L["ammo.alyxgun"] = "Munición del Arma de Alyx"
...
L["customize.stats.shootentforce"] = "Velocidad de salida"
...
L["customize.stats.explain.shootentforce"] = "La velocidad de salida de las balas disparadas con esta arma."
...
L["autostat.damagemax"] = "Daño Máximo"
L["autostat.damagemin"] = "Daño Mínimo"
...
L["autostat.shootentforce"] = "Velocidad del Proyectil"
...
L["autostat.dispersionspread"] = "Esparción de perdigones"
...
L["autostat.secondary.bipod"] = "%s en Bípode"
L["autostat.secondary.crouch"] = "%s mientras está agachado"
L["autostat.secondary.empty"] = "%s en la ultima ronda del cargador"
L["autostat.secondary.evenreload"] = "%s cada recarga pareja"
L["autostat.secondary.evenshot"] = "%s cada disparo parejo"
L["autostat.secondary.first"] = "%s en el primer disparo"
L["autostat.secondary.firstshot"] = "%s en el primer disparo"
L["autostat.secondary.heated"] = "%s mientras Calentado"
L["autostat.secondary.hipfire"] = "%s en Hipfire"
L["autostat.secondary.hot"] = "%s del Calor"
L["autostat.secondary.last"] = "%s en la ultima ronda del cargador"
L["autostat.secondary.lastshot"] = "%s en la ultima ronda del cargador"
L["autostat.secondary.midair"] = "%s en el aire"
L["autostat.secondary.move"] = "%s mientras se mueve"
L["autostat.secondary.oddreload"] = "%s cada recarga rara"
L["autostat.secondary.oddshot"] = "%s cada disparo raro"
L["autostat.secondary.recoil"] = "%s del retroceso" --"Con Cada Disparo"
L["autostat.secondary.shooting"] = "%s mientras dispara"
L["autostat.secondary.sighted"] = "%s mientras Avistado"
L["autostat.secondary.sights"] = "%s en la mira"
L["autostat.secondary.silenced"] = "%s cuando está silenciado"
L["autostat.secondary.sprint"] = "%s al Esprintar"
L["autostat.secondary.true"] = "%s cuando Verdaderos Nombres está activo"
L["autostat.secondary.ubgl"] = "%s en UBGL"
...
L["tips.discord"] = "¡Únete a Doves International en Discord! El enlace está en la descripción ARC9 y en la parte superior de la configuración."
...
L["settings.gameplay.fx_rtvm.title"] = "Renderizar Arma a través de Miras RT"
...
L["premium.help.ownedbutnoaccess"] = "¿Ha comprado recientemente ARC9 Premium, pero no tiene acceso automático a él? Ponte en contacto con nosotros en el servidor Discord de Doves International para obtener ayuda.\nAsegúrese de que puede proporcionar una prueba de compra antes de ponerse en contacto. Decir simplemente \"compro, ahora doy\" no es suficiente."
...
- Acceso a un modo de interfaz RGB exclusivo
- Camuflajes exclusivos disponibles a través de la base
- Canal de soporte exclusivo en Discord**
- Diseño de menú de aparición nuevo, mejorado y exclusivo**
- Rendimiento y apariencia de TPIK mejorados**

*Requiere administrador si estás en un servidor
**No disponible con la <color=255,106,0>Prueba gratuita</color>
]]
...
Si sigues teniendo problemas, o si todavía no se te ha concedido Premium, entonces visita el servidor Discord de Doves International y proporciona una prueba válida de compra, y lo arreglaremos para ti.
]]

L["premium.freetrial"] = "Received <color=255,106,0>ARC9 Premium (Free Trial)</color>!"
L["premium.freetrial.desc"] = [[
¡Gracias por apoyar a ARC9!

Como muestra de nuestro agradecimiento, ¡te regalamos ARC9 Premium por <color=255,106,0>3 días</color>!
...
L["premium.payment.free.title"] = "ARC9 Premium (Prueba gratuita)"
L["premium.payment.free.desc"] = [[
Precio: <color=100,255,100>GRATIS</color>

Consigue ARC9 Premium por <color=255,106,0>3 días</color>.
]]

L["premium.payment.month.title"] = "ARC9 Premium (1 mes)"
L["premium.payment.month.desc"] = [[
Precio: <color=100,255,100>€5</color>
...
L["premium.payment.6mon.title"] = "ARC9 Premium (6 + 1 mes)"
L["premium.payment.6mon.desc"] = [[
Precio: <color=100,255,100>€30</color> [ ¡OFERTA ESPECIAL! ]

Consigue ARC9 Premium por <color=255,106,0>6 meses</color>.
¡Incluye <color=100,255,100>un mes gratis</color>!
]]
